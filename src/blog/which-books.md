...
layout: blog_post
title: Which Books?
description: Catholics, Orthodox Christians, and Protestants all read slightly different Bibles. The skeptic who sees that disagreement as evidence that none of it can be trusted turns out to have the wrong conclusion — and the evidence says why.
date: 2026-04-09
...
The councils — the Council of Hippo in 393 CE, the Council of Carthage in 397 CE — did not invent the canon. They recognized and ratified what the church had already been treating as Scripture for generations. Think of it this way: a NASA meeting that ratifies a set of engineering specifications did not create those specifications. The engineers did. The meeting confirms what the engineers built. The councils confirmed what the apostles and their associates produced.
...
Suppose I call a meeting at NASA to evaluate propulsion systems for a deep space mission. A paper arrives on my desk. The author is listed as M. Scott, Chief Engineer, USS Enterprise. The paper discusses warp field theory and cites the work of Miguel Alcubierre — a real Mexican physicist who proposed a genuine theoretical framework for warp propulsion in 1994. The citation is real. The physics is interesting. The author is not.

Nobody in that meeting accepts the paper. Not because warp theory is unworthy of consideration. Not because Alcubierre's work is without value. But because M. Scott, Chief Engineer of the USS Enterprise, did not write it — and everyone in the room knows it.
...
- **Philip Jenkins, *The Lost History of Christianity*** (HarperOne, 2008) — helpful context for understanding early Christian diversity without sensationalizing it
- **Bart Ehrman, *Lost Christianities: The Battles for Scripture and the Faiths We Never Knew*** (Oxford, 2003) — represents the skeptical position with scholarly rigor; worth reading to understand the best version of the critical argument
