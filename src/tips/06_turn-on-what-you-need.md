...
category: site
description: Every feature on this site has an off switch. Use Settings to show only what you actually use.
---
...
Nothing about this choice leaves your browser. The site stores it the same way it stores your journal and your progress, on your own device, never on a server. Turning a feature off does not delete anything behind it either; your journal entries stay exactly where they were if you turn Journaling back on next month.

Start with everything on, use the site for a week, and then turn off whatever you never touched. A page that only shows what you actually use is easier to read than one that shows everything it is capable of.
